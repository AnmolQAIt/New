...
public class YamlReader {
    ...
    public static String yamlFilePath = "src/test/resources/testdata/QA2_TestData.yml";

    public static String setYamlFilePath() {
        String tier = getProperty("Config.properties", "tier").trim();
        System.out.println("Application Enviroment: " +tier);
        if (tier.equalsIgnoreCase("dev")) {
            yamlFilePath = "src/test/resources/testdata/DEV_TestData.yml";
        } else if (tier.equalsIgnoreCase("qa2")) {
            yamlFilePath = "src/test/resources/testdata/QA2_TestData.yml";
        } else if (tier.equalsIgnoreCase("qa3")) {
            yamlFilePath = "src/test/resources/testdata/QA3_TestData.yml";
        } else if (tier.equalsIgnoreCase("stage") || tier.equalsIgnoreCase("staging")) {
        ...
        System.out.println("Application Enviroment details Files: " +yamlFilePath);
        return yamlFilePath;
    }
